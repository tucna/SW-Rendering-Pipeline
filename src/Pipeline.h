...
public:
  ...
  void SetPSBuffers(float3 Kd, float3 Ka, float3 lightPosition, float3 cameraPosition, byte4* texture0) { m_Kd = Kd; m_Ka = Ka; m_lightPosition = lightPosition; m_cameraPosition = cameraPosition; m_texture0 = texture0; }
